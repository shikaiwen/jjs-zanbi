...
var _265="<div align=\"center\">"+msg+"</div>";
switch(icon){
case "error":
...
},message:"Please enter a valid URL."},mobile:{validator:function(_4e1){
return /^(13[0-9]|15[0|1|2|3|4|5|6|8|9]|18[0-9])\d{8}$/.test(_4e1);	
},message:"Please enter a valid mobile."},IDCardNo:{validator:function(_4e2){
return /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/.test(_4e2);	
},message:"Please enter a valid IDCardNo"},length:{validator:function(_3ea,_3eb){
...
$(_853).combo("setValue","").combo("setText","");
$(_853).combo("hidePanel");
});
